...
<head>
  ...
  <style>
    @import url(https://cdn.jsdelivr.net/gh/ASparkOfFire/GoIndex-theme@updates/dist/style.min.css);
  </style>
  <script>
...
<body>
    <div id="app"></div>
    <script src="https://cdn.jsdelivr.net/gh/ASparkOfFire/GoIndex-theme@updates/dist/app.min.js"></script>
</body>
</html>
`;
}
